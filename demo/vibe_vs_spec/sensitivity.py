...
# 케이스 스터디 본문의 -8.3%는 측정 당시(2026-08) GPT-5 단가 기준.
# 이후 단가가 바뀌어도(예: 2026-09 GPT-5.x $5/$30) 결론은 불변 — 그것이 이 실험의 요점.
# 최신 단가는 lab/pricing.py 참조.
MODELS = {
    "GPT-5 (2026-08)":   (1.25, 10.00),   # 케이스 스터디 기준 단가
    "GPT-5.x (2026-09)": (5.00, 30.00),   # lab/pricing.py 갱신 반영
