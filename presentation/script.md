...
44장 · 약 30분 · 2026-09-20 · 생성 원천: `presentation/deckgen/build_verified.py`와 원자료.
...
## 26. 모델 라우팅 · 쉬운 요청에 비싼 모델을 쓰지 않는다
